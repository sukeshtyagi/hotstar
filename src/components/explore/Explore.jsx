  ...
  return (
    <div className="exploreContainer box-border w-screen  flex bg-black overflow-y-atuo ">
      ...
      <div className="rightDiv box-border w-10/12 flex flex-col m-auto ml-44">
        <div className="header box-border w-full h-1/2 caret-transparent	flex justify-start gap-6 items-center my-14 bg-gray-700 p-2 text-white rounded-xl">
          <svg
          ...
          <p className="search box-border h-fit text-2xl text-gray-400 py-3">
